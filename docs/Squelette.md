...
- <nomComplet1>Nicolas Robitaille</nomComplet1>
- <courriel1>nicolas.robitaille.2@ens.etsmtl.ca</courriel1>
- <codeMoodle1>AV09330</codeMoodle1>
- <githubAccount1>mostofit</githubAccount1>
...
1. Le Joueur demande à lancer les 3 dés.
1. Le Système affiche le nom du joueur et le résultat de la partie, ainsi que le nombre de parties et le nombre de fois que le Joueur a gagné. Pour un lancer, si le total est plus petit ou égal à 10, le Joueur a gagné. Dans tous les autres cas, il a perdu.
